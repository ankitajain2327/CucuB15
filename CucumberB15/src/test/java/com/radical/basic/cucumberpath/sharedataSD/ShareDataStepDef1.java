...
public class ShareDataStepDef1 {
	...
	public ShareDataStepDef1(SharedClass share){    // using driver of shared class with extending that class bcoz inheritance is not supported by cucumber. we can pass that class in constuctor.
		
		driver = share.setup(); // everytime driver will get initialise when constructor is created.
	}
